...
public static class Define
{
    ...
    public const Int16 FONTSIZE1              = 10;    //フォントサイズ（小）
    public const Int16 FONTSIZE2              = 15;   //フォントサイズ（大）
    public const Int16 MEMORY_UPDATE_INTERVAL = 500;  //メモリ使用量更新頻度(ms)
    public const Int16 USAGE_UPDATE_INTERVAL  = 500;  //CPUGPU使用率更新頻度(ms)
    public const Int16 DATE_UPDATE_INTERVAL   = 100;  //時刻表示更新頻度(ms)
}